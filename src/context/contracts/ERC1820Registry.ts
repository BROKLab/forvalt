...
export type SymfoniERC1820Registry = ReturnType<typeof getERC1820Registry>;

export function getERC1820Registry(provider: providers.Provider, chainId: number, signer?: Signer, address?: string) {
