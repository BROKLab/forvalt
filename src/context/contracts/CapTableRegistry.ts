...
export type SymfoniCapTableRegistry = ReturnType<typeof getCapTableRegistry>;

export function getCapTableRegistry(provider: providers.Provider, chainId: number, signer?: Signer, address?: string) {
